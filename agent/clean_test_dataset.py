...
source_file_path = os.path.join(cache_dir, 'test.jsonl') # Changed to test.jsonl

# Path for the new clean file in the current project directory
cleaned_file_path = 'cleaned_test.jsonl' # Changed to cleaned_test.jsonl

# Columns that might have mixed types and should be converted to strings
stringify_cols = ['denomValue', 'numValue', 'pmid'] # Same problematic columns
